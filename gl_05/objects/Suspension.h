...
public:
	Suspension() {
		...
		auto connector = std::unique_ptr<Cube>(new Cube(silver));
		...
		connector->move(glm::vec3(-0.28f, 0.02f, 0.0f));
		connector->rotate(glm::vec3(0.0f, 0.0f, 90.0f));
		connector->scale(glm::vec3(0.05f, 0.4f, 0.03f));
		rear->move(glm::vec3(-0.5f, 0.0f, 0.0f));
		rear->rotate(glm::vec3(0.0f, 0.0f, -45.0f));
		rear->scale(glm::vec3(0.05f, 0.5f, 0.03f));
		tire1->move(glm::vec3(-0.66f, -0.17f, -0.11f));
		tire1->rotate(glm::vec3(90.0f, 0.0f, 0.0f));
		tire2->move(glm::vec3(-0.26f, -0.17f, -0.11f));
		tire2->rotate(glm::vec3(90.0f, 0.0f, 0.0f));
		tire3->move(glm::vec3(0.22f, -0.17f, -0.11f));
		tire3->rotate(glm::vec3(90.0f, 0.0f, 0.0f));
		

		addObject(std::move(rear));
		addObject(std::move(connector));
